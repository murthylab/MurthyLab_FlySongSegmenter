function MergedInTimeHarmonics = SineSegmenter(data, ...
...
if numel(inRangeEvents) == 0
    ...
    MergedInTimeHarmonics.num_events = [];
    MergedInTimeHarmonics.start = [];
    MergedInTimeHarmonics.stop = [];
    MergedInTimeHarmonics.length = [];
    return
end
...
if(isempty(sine_start))
  ...
  MergedInTimeHarmonics.length = sine_stop - sine_start;
